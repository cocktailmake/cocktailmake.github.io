...
.. description: 
.. type: text
.. previewimage: /images/abstract-of-web-api/example/example.png
...
| METHOD | URL Path                       | explain                                  |
|--------+--------------------------------+------------------------------------------|
| GET    | /v1/projects/                  | Get a list of projects                   |
| GET    | /v1/projects/id/               | Get information about a specific project |
| POST   | /v1/projects/                  | Create a project                         |
| PUT    | /v1/projects/id/               | Update project information               |
| DELETE | /v1/projects/id/               | Delete the project                       |
...
[[img-url:/images/abstract-of-web-api/example/example.png]]
